...
class FirstTimeExperience: ObservableObject {
    ...
    enum OnboardingStep: Int, CaseIterable {
        ...
        var title: String {
            switch self {
            case .welcome: return "Welcome to Eoel"
        ...
        var description: String {
            ...
            case .explainer:
                return "Eoel translates your biofeedback into immersive audio-visuals. This is art, not medicine."
            case .permissions:
...
struct PermissionsStepView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("Eoel works great without any permissions.\nConnect more sensors for enhanced experiences.")
                .font(.body)
                .multilineTextAlignment(.center)
                .foregroundColor(.white.opacity(0.9))
                .padding(.horizontal, 40)
