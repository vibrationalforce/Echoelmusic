...
class PerformanceOptimizer: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.eoel.performance", category: "Optimization")
    ...
    private func adjustForBattery() {
        ...
        if performanceMode != .eoel && performanceMode != .batterySaver {
