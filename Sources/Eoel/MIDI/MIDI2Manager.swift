...
class MIDI2Manager: ObservableObject {
    ...
    func initialize() async throws {
        ...
        do {
            ...
            let clientStatus = MIDIClientCreateWithBlock("Eoel_MIDI2_Client" as CFString, &client) { notification in
            ...
            let sourceStatus = MIDISourceCreateWithProtocol(
                midiClient,
                "Eoel MIDI 2.0 Output" as CFString,
