...
class BackgroundSourceManager: ObservableObject {
    ...
    private var blabVisualRenderer: EOELVisualRenderer?
    ...
    enum BackgroundSource: Identifiable, Equatable {
        ...
        case blabVisual(EOELVisualType)
        ...
        var displayName: String {
            ...
            case .blabVisual(let type): return "EOEL: \(type.displayName)"
    ...
    private func startEOELVisual(type: EOELVisualType) async throws {
        ...
        blabVisualRenderer = EOELVisualRenderer(device: device, type: type)
