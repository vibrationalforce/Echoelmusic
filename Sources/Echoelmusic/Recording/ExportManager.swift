...
class ExportManager {
    ...
    func exportAudio(
        ...
        log.audio("📤 Exported audio: \(exportURL.lastPathComponent)")
        return exportURL
    }
    ...
    func exportBioData(
        ...
        log.audio("📤 Exported bio-data: \(exportURL.lastPathComponent)")
        return exportURL
    }
    ...
    func exportSessionPackage(
        ...
        log.audio("📦 Exported session package: \(packageURL.lastPathComponent)")
        return packageURL
    }
