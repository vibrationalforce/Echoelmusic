//
//  EchoelmusicIconLibrary.swift
//  Echoelmusic
//
//  Created: 2025-11-25
//  Copyright © 2025 Echoelmusic. All rights reserved.
//
//  Echoelmusic Icon Library
...
/// Central icon library for Echoelmusic
struct EchoelmusicIcon {
            ...
            VStack(spacing: VaporwaveDesignSystem.Spacing.xlarge) {
                ...
                VStack(spacing: VaporwaveDesignSystem.Spacing.medium) {
                    ...
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 6)) {
                        NeonIcon(systemName: EchoelmusicIcon.Music.waveformCircle, color: VaporwaveDesignSystem.Colors.neonCyan)
                        NeonIcon(systemName: EchoelmusicIcon.Transport.playCircle, color: VaporwaveDesignSystem.Colors.laserGreen)
                        NeonIcon(systemName: EchoelmusicIcon.Transport.recordFill, color: VaporwaveDesignSystem.Colors.neonPink)
                        NeonIcon(systemName: EchoelmusicIcon.MIDI.piano, color: VaporwaveDesignSystem.Colors.neonPurple)
                        NeonIcon(systemName: EchoelmusicIcon.Effects.reverb, color: VaporwaveDesignSystem.Colors.electricBlue)
                        NeonIcon(systemName: EchoelmusicIcon.Sync.sync, color: VaporwaveDesignSystem.Colors.sunsetOrange)
                    }
                }
                ...
                VStack(spacing: VaporwaveDesignSystem.Spacing.medium) {
                    ...
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 6)) {
                        ChromeIcon(systemName: EchoelmusicIcon.Music.music, size: 40)
                        ChromeIcon(systemName: EchoelmusicIcon.MIDI.synth, size: 40)
                        ChromeIcon(systemName: EchoelmusicIcon.Effects.eq, size: 40)
                        ChromeIcon(systemName: EchoelmusicIcon.Studio.settings, size: 40)
                        ChromeIcon(systemName: EchoelmusicIcon.Vaporwave.cube, size: 40)
                        ChromeIcon(systemName: EchoelmusicIcon.Vaporwave.pyramid, size: 40)
                    }
                }
                ...
                VStack(spacing: VaporwaveDesignSystem.Spacing.medium) {
                    ...
                    HStack(spacing: VaporwaveDesignSystem.Spacing.xlarge) {
                        PulsingIcon(
                            systemName: EchoelmusicIcon.Recording.recCircle,
                            color: VaporwaveDesignSystem.Colors.neonPink,
                            size: 48
                        )

                        RotatingIcon(
                            systemName: EchoelmusicIcon.Sync.sync,
                            color: VaporwaveDesignSystem.Colors.neonCyan,
                            size: 48
                        )

                        StatusIcon(
                            systemName: EchoelmusicIcon.Collaboration.broadcast,
                            status: .active,
                ...
                VStack(spacing: VaporwaveDesignSystem.Spacing.medium) {
                    ...
                    HStack(spacing: VaporwaveDesignSystem.Spacing.large) {
                        TransportButton(
                            icon: EchoelmusicIcon.Transport.backward,
                            action: {},
                            color: VaporwaveDesignSystem.Colors.neonCyan,
                            size: 56
                        )
                        ...
                        TransportButton(
                            icon: EchoelmusicIcon.Transport.play,
                            action: {},
                            isActive: true,
                            color: VaporwaveDesignSystem.Colors.laserGreen,
                            size: 72
                        ...
                        TransportButton(
                            icon: EchoelmusicIcon.Transport.recordFill,
                            action: {},
                            color: VaporwaveDesignSystem.Colors.neonPink,
                            size: 56
                        )
                        ...
                        TransportButton(
                            icon: EchoelmusicIcon.Transport.forward,
                            action: {},
                            color: VaporwaveDesignSystem.Colors.neonCyan,
                            size: 56
                        )
