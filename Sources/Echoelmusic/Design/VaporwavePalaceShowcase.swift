...
//  The ultimate Echoelmusic interface experience
//

import SwiftUI

/// Complete showcase of Echoelmusic design system
struct VaporwavePalaceShowcase: View {
    @StateObject private var themeManager = EchoelmusicThemeManager.shared
    ...
    private var headerView: some View {
        HStack {
            ...
            HStack(spacing: VaporwaveDesignSystem.Spacing.small) {
                if isRecording {
                    PulsingIcon(
                        systemName: EchoelmusicIcon.Transport.recordFill,
    ...
    private var tabBarView: some View {
        LiquidGlassTabBar(
            ...
            tabs: [
                (EchoelmusicIcon.Studio.project, "Dashboard"),
                (EchoelmusicIcon.Mixing.mixer, "Controls"),
                (EchoelmusicIcon.Mixing.fader, "Mixer"),
                (EchoelmusicIcon.Effects.eq, "Effects")
            ],
            ...
            LiquidGlassCard(glowColor: themeManager.secondary) {
                VStack(spacing: VaporwaveDesignSystem.Spacing.large) {
                    ...
                    HStack(spacing: VaporwaveDesignSystem.Spacing.large) {
                        ...
                        TransportButton(
                            icon: isPlaying ? EchoelmusicIcon.Transport.pause : EchoelmusicIcon.Transport.play,
            ...
            LiquidGlassCard(glowColor: themeManager.primary) {
                VStack(spacing: VaporwaveDesignSystem.Spacing.medium) {
                    ...
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 6), spacing: 20) {
                        NeonIcon(systemName: EchoelmusicIcon.Music.waveformCircle, color: themeManager.primary, size: 32)
                        NeonIcon(systemName: EchoelmusicIcon.Transport.playCircle, color: themeManager.secondary, size: 32)
                        NeonIcon(systemName: EchoelmusicIcon.MIDI.piano, color: themeManager.accent, size: 32)
                        ChromeIcon(systemName: EchoelmusicIcon.Effects.eq, size: 32)
                        ChromeIcon(systemName: EchoelmusicIcon.Effects.reverb, size: 32)
                        ChromeIcon(systemName: EchoelmusicIcon.Vaporwave.cube, size: 32)
                    }
                }
            }
