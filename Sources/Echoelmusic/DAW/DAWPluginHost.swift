...
class DAWPluginHost: ObservableObject {
    ...
    enum PluginFormat: String, CaseIterable {
        ...
        case vst3 = "VST3"
        case clap = "CLAP"
        case custom = "Echoelmusic Plugin"
    ...
    struct PluginPreset: Identifiable, Codable {
        ...
        static let factoryPresets: [PluginPreset] = [
            PluginPreset(name: "Default", manufacturer: "Echoelmusic"),
            PluginPreset(name: "Init", manufacturer: "Echoelmusic"),
        ]
    }
    ...
    func scanPlugins() async {
        ...
        // TODO: Scan custom Echoelmusic plugins
