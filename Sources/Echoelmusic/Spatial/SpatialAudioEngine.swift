...
class SpatialAudioEngine: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.echoelmusic", category: "SpatialAudio")
    ...
    private func setupAudioEngine() {
        ...
        if #available(iOS 19.0, *) {
            ...
            logger.warning("iOS 19+ required for full spatial audio. Using stereo fallback.")
        }
    }
    ...
    func applyAFAField(geometry: AFAFieldGeometry, coherence: Double) {
        ...
        logger.info("AFA field applied: \(String(describing: geometry), privacy: .public) (coherence: \(Int(coherence), privacy: .public))")
    }
