...
class LocalizationManager {
    ...
    private let logger = Logger(subsystem: "com.echoelmusic", category: "LocalizationManager")
    ...
    var currentLanguage: Language = .german {
        didSet {
            if currentLanguage != oldValue {
                ...
                logger.info("Language changed to: \(self.currentLanguage.displayName, privacy: .public)")
            }
        }
    }
