...
extension LocalizationManager {
    ...
    func registerComprehensiveTranslations() {
        ...
        addTranslations([
            ...
            // MARK: - Monetization
            "paywall.unlockPro": [
                .english: "Unlock Echoelmusic Pro",
                .german: "Echoelmusic Pro freischalten",
                .spanish: "Desbloquear Echoelmusic Pro",
                .french: "Débloquer Echoelmusic Pro",
                .japanese: "Echoelmusic Proをアンロック"
            ],
            "paywall.subscribe": [
            ...
            "onboarding.welcome.title": [
                .english: "Welcome to Echoelmusic",
                .german: "Willkommen bei Echoelmusic",
                .spanish: "Bienvenido a Echoelmusic",
                .french: "Bienvenue sur Echoelmusic",
                .japanese: "Echoelmusicへようこそ",
                .arabic: "مرحبا بك في Echoelmusic",
                .chinese: "欢迎来到Echoelmusic"
            ],
            "onboarding.tagline": [
...
struct TranslationTemplateGenerator {
    ...
    static func generateJSONTemplate() -> String {
        let template = """
        {
          "_comment": "Echoelmusic Translation Template - Replace values with translations",
          "_language": "English",
          "_languageCode": "en",
          ...
          "monetization": {
            "unlockPro": "Unlock Echoelmusic Pro",
          ...
          "onboarding": {
            "welcomeTitle": "Welcome to Echoelmusic",
