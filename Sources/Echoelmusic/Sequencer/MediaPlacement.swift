...
// of that lane's content, spanning whole bars at the song tempo, unwarped. Two doors that placed
// the same file in two different places would be two opinions about where a file goes.
//
...
public enum MediaPlacement {
    ...
    public static func plan(_ key: MediaAsset.Key,
        ...
        return .reuse(AudioClipFactory.unwarpedRegion(
    ...
    public static func place(_ asset: MediaAsset,
        ...
        let needsMeasure = carryingClip(asset.key, in: clips).map { clip in
    ...
    public static func perform(_ asset: MediaAsset,
        ...
        place(asset, clipStore: clipStore, timeline: timeline, bpm: bpm,
