...
public final class AbletonLinkClient {
    ...
    @ObservationIgnored nonisolated(unsafe) private var multicastConnection: NWConnectionGroup?
    @ObservationIgnored nonisolated(unsafe) private var unicastListener: NWListener?
    @ObservationIgnored nonisolated(unsafe) private var updateTimer: Timer?
    @ObservationIgnored nonisolated(unsafe) private var discoveryTimer: Timer?
