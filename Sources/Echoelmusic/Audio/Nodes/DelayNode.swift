...
private let delayNodeLogger = Logger(subsystem: "com.echoelmusic", category: "DelayNode")
...
class DelayNode: BaseEchoelmusicNode {
    ...
    override func start() {
        super.start()
        delayNodeLogger.info("🎵 DelayNode started")
    }

    override func stop() {
        super.stop()
        delayNodeLogger.info("🎵 DelayNode stopped")
    }
