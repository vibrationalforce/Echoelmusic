...
struct MLInferenceResult {
    ...
    func getValue<T>(for key: String) -> T? {
        if let feature = output.featureValue(for: key) {
            switch feature.type {
            case .double: return feature.doubleValue as? T
            case .int64: return feature.int64Value as? T
            case .string: return feature.stringValue as? T
            case .multiArray: return feature.multiArrayValue as? T
            default: return nil
            }
        }
