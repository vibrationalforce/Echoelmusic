...
//  senders forward ONLY Echoel's OWN measurements (camera rPPG, BLE strap, the demo
//  generator) and never frames sourced from Apple Health / Watch / ring bridges.
//  Mirrors the non-circular pattern of
