...
final class UnifiedLightingController: ObservableObject {
    ...
    func enableAudioReactive(audioAnalysis: @escaping () -> EchoelmusicAudioEngine.AudioAnalysis) {
    ...
    private func updateLightsFromAudio(_ analysis: EchoelmusicAudioEngine.AudioAnalysis) async {
