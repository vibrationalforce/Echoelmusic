...
class BackgroundSourceManager: ObservableObject {
    ...
    private var echoelVisualRenderer: EchoelmusicVisualRenderer?
    ...
    enum BackgroundSource: Identifiable, Equatable {
        ...
        case echoelVisual(EchoelmusicVisualType)
        ...
        var id: String {
            ...
            case .echoelVisual(let type): return "echoel_\(type.rawValue)"
        ...
        var displayName: String {
            ...
            case .echoelVisual(let type): return "Echoelmusic: \(type.displayName)"
    ...
    private func initializeDefaultSources() {
        availableSources = [
            ...
            .echoelVisual(.cymatics),
            .echoelVisual(.mandala),
            .echoelVisual(.particles),
            .echoelVisual(.waveform),
            .echoelVisual(.spectral),
    ...
    func getCurrentTexture(size: CGSize) async throws -> MTLTexture {
        ...
        case .video, .liveCamera, .echoelVisual, .gradient(.bioreactive, _):
    ...
    private func startEchoelmusicVisual(type: EchoelmusicVisualType) async throws {
        ...
        echoelVisualRenderer = EchoelmusicVisualRenderer(device: device, type: type)
    ...
    private func updateEchoelmusicVisual(type: EchoelmusicVisualType, size: CGSize) async throws -> MTLTexture {
        guard let renderer = echoelVisualRenderer else {
            throw BackgroundError.echoelVisualNotActive
        }
