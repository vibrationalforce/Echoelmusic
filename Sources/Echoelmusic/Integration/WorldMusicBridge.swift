...
class WorldMusicBridge: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.echoelmusic", category: "WorldMusic")
    ...
    private init() {
        loadMusicStyles()
        logger.info("WorldMusicBridge: Loaded \(self.availableStyles.count, privacy: .public) music styles")
    }
