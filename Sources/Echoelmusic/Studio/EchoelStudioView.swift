...
//   surviving two lines above the paragraph that rejects it.)
    ...
    private func generate(startTransport: Bool = true,
        ...
        //  · "Pure Flächen run straight" is already what the DATA says: of the 19 genres in
        //    `MusicStyle.offered`, TWELVE return `swing == 0` — the calm ones plus acid, trance,
        //    dark minimal and psy-prog. The hardwire did not protect them; it silenced the other seven.
        //
        ...
        // infer it. Both decisions it shifts sit behind `!sustained`, and 8 of the 19 offered
