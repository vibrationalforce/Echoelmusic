...
struct PrivacyDashboardView: View {
    ...
    private var privacyOverviewSection: some View {
        Section {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Echoelmusic is designed with privacy-first principles. You have full control over your data.")
                    .font(.caption)
    ...
    private var consentManagementSection: some View {
        Section {
            ConsentToggle(
                title: "Analytics",
                description: "Help improve Echoelmusic by sharing anonymous usage data",
            ...
            NavigationLink {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("What Data We Collect")
                        .font(.headline)
                    Text("See exactly what information Echoelmusic collects and why")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
            }
