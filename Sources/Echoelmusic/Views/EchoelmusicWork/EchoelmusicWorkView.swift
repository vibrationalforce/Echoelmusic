...
struct EchoelmusicWorkView: View {
    @EnvironmentObject var eoelWorkManager: EchoelmusicWorkManager
    @State private var selectedIndustry: EchoelmusicWorkManager.Industry?
    ...
    var body: some View {
        NavigationView {
            if eoelWorkManager.currentUser == nil {
                ...
                // Main EchoelmusicWork Dashboard
                DashboardView()
            }
        }
    }
...
struct IndustryGrid: View {
    let industries = EchoelmusicWorkManager.Industry.allCases
...
struct DashboardView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("EchoelmusicWork")
        .toolbar {
...
#Preview {
    EchoelmusicWorkView()
        .environmentObject(EchoelmusicWorkManager.shared)
}
