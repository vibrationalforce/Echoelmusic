...
public final class EchoelVoiceAudioUnit: AUAudioUnit {
    ...
    public override init(
        ...
        guard let defaultFormat = AVAudioFormat(
            ...
            throw NSError(domain: "com.echoelmusic.voice", code: -1,
...
@_cdecl("EchoelVoiceAudioUnitFactory")
public func EchoelVoiceAudioUnitFactory(
    _ desc: UnsafePointer<AudioComponentDescription>
) -> Unmanaged<AnyObject>? {
    do {
        let audioUnit = try EchoelVoiceAudioUnit(
