...
struct EOELWidgetProvider: TimelineProvider {
...
struct EOELWidget: Widget {
    let kind: String = "EOELWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: EOELWidgetProvider()) { entry in
            WidgetEntryView(entry: entry)
        }
        .configurationDisplayName("EOEL")
...
@main
struct EOELWidgetBundle: WidgetBundle {
