...
- **Character params — LIVE (2026-06-17):** `MoodProfile` now 8 dims (… + **virtuosity, syncopation, humanize**), all consumed in the lead generator. **19 offered genres** (`MusicStyle.offered`; the enum holds 36 cases, so **17** are not offered — the curation is by ear and re-offering one is a listening decision. ⛔ This said "nine older ones": 36 − 19 = 17 (33 − 16 before #983 S3–S5 added three genres to both sides), and it was 17 at the 2026-07-24 curation too (25 declared, 8 offered). Nothing in the tree counts to nine).
