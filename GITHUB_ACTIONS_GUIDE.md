# 🚀 Echoelmusic - GitHub Actions Cloud Build Guide
...
```bash
cd /Users/michpack/EchoelmusicStudio

# Bei GitHub anmelden
gh auth login

# Repository erstellen
gh repo create Echoelmusic --public --source=. --remote=origin --push
```
...
4. **GitHub zeigt dir Commands:**
   ```bash
   git remote add origin https://github.com/DEIN_USERNAME/Echoelmusic.git
   git branch -M main
...
5. **Im Terminal (VS Code unten):**
   ...
   git branch -M main
   git add .
   git commit -m "Initial commit - Echoelmusic iOS App"
   git push -u origin main
   ```
...
1. **Gehe zu deinem Repository:**
   https://github.com/DEIN_USERNAME/Echoelmusic
...
3. **Download:** `Echoelmusic-iOS-App.zip`

4. **Entpacke die Zip-Datei**
   - Du bekommst: `Echoelmusic-unsigned.ipa`
...
4. **Sideloadly öffnen:**
   - IPA auswählen: `Echoelmusic-unsigned.ipa`
...
- **Echoelmusic Build:** ~10 Minuten pro Build
...
- **Dein GitHub Repo:** https://github.com/DEIN_USERNAME/Echoelmusic
