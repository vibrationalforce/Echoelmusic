# 🚀 Eoel - GitHub Actions Cloud Build Guide
...
```bash
cd /Users/michpack/EoelStudio

# Bei GitHub anmelden
gh auth login

# Repository erstellen
gh repo create eoel-ios-app --public --source=. --remote=origin --push
```
...
4. **GitHub zeigt dir Commands:**
   ```bash
   git remote add origin https://github.com/DEIN_USERNAME/eoel-ios-app.git
   git branch -M main
...
5. **Im Terminal (VS Code unten):**
   ...
   git branch -M main
   git add .
   git commit -m "Initial commit - Eoel iOS App"
   git push -u origin main
   ```
...
1. **Gehe zu deinem Repository:**
   https://github.com/DEIN_USERNAME/eoel-ios-app
...
3. **Download:** `Eoel-iOS-App.zip`

4. **Entpacke die Zip-Datei**
   - Du bekommst: `Eoel-unsigned.ipa`
...
4. **Sideloadly öffnen:**
   - IPA auswählen: `Eoel-unsigned.ipa`
...
Edit: `Sources/Eoel/ContentView.swift`
...
Edit: `Sources/Eoel/ParticleView.swift`
...
Edit: `Sources/Eoel/MicrophoneManager.swift`
...
- **Eoel Build:** ~10 Minuten pro Build
...
- **Dein GitHub Repo:** https://github.com/DEIN_USERNAME/eoel-ios-app
