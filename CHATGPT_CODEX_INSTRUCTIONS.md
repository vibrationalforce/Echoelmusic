...
Claude Code hat **Week 1 des ECHOEL-Projekts** fertig implementiert und braucht jetzt dein Debug/Optimize-Expertenwissen.
...
2. **Implementation Files:**
   - `Sources/Echoel/Unified/UnifiedControlHub.swift`
   - `Sources/Echoel/Spatial/ARFaceTrackingManager.swift`
   - `Sources/Echoel/Unified/FaceToAudioMapper.swift`
...
4. **Architecture:**
   - `ECHOEL_EXTENDED_VISION.md`
   - `ECHOEL_90_DAY_ROADMAP.md`
