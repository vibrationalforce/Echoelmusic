...
Claude Code hat **Week 1 des Eoel-Projekts** fertig implementiert und braucht jetzt dein Debug/Optimize-Expertenwissen.
...
2. **Implementation Files:**
   ...
   - `Sources/Eoel/Spatial/ARFaceTrackingManager.swift`
   - `Sources/Eoel/Unified/FaceToAudioMapper.swift`
