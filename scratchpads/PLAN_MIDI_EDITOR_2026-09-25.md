...
- **M3 — duplicate · velocity · quantize · transpose** (buttons over the selection; velocity lane later).
- **M4 — scale-aware** (Scale-Lock on create/move/transpose via `MusicalKey.quantize`; `RollNoteOps` with a bar parameter).
