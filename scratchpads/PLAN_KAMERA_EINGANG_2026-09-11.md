...
**Stand 2026-09-11 10:40 UTC:** K1 `0f5212f` · K2 `ebc1f98` · K3 `d2fe686` · K4a `4f87ba3` · K4b `8e335f9` · K5a `5bbec8d` · K5b `a507c72` · K6a `b8b8d0c` gepusht; Compile Check grün bis K5b (#2560), Build for Testing grün für K1/K2/K4a (6019/6020/6022), Rest siehe SESSION_LOG. K6b (motionEnergy) GESTRICHEN — nicht im Prompt. Offen: K7 (Segmentierung), Thermik-Leiter sichtbar, Tracking-Rate 30 Hz, Querformat-Orientierung für Vision. OSC-Namensraum `/echoelmusic/gesture/` (Prompt: `/echoel/`).
