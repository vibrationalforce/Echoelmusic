...
**Stand 2026-09-11 11:05 UTC:** K1 `0f5212f` · K2 `ebc1f98` · K3 `d2fe686` · K4a `4f87ba3` · K4b `8e335f9` · K5a `5bbec8d` · K5b `a507c72` · K6a `b8b8d0c` · K7 `e8d003c` · K6c `7c8c0e8` · K7b `f7b594f` gepusht — alle sieben Prompt-Scheiben gebaut. Compile Check grün bis K5b (#2560), Build for Testing grün für K1/K2/K3/K4a/K4b (6019–6023); K6a–K7b: Compile-Lauf auf `f7b594f` lesen. Bewusst offen: 6b-Fallback ohne TrueDepth (Gerätesondierung zuerst), Gerät-Verify aller NEEDS-FOUNDER-VERIFY (`python3 scripts/founder-verify.py --since 1438077`), FEATURE_MATRIX-Zeile nach dem ersten Build. OSC-Namensraum `/echoelmusic/gesture/` (Prompt: `/echoel/`); Segmentierung `.personSegmentation` statt `…WithDepth`.
