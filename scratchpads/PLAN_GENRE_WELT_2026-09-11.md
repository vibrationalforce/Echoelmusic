...
| G15b-2 (OFFEN) | Dark Synth Scenes (neu) | slowedGothPop | Unblockiert. Eigene Scheibe nach der G10a-Form (Regal + erstes Genre). ⚠️ `harmonicMinor`/`halfTime`/`[0,1]`/`[0,2,4]` gegen `vaporwave` und `doom` vorher messen |
