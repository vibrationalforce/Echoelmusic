...
| G15b (OFFEN) | Dub & Drone · Dark Synth Scenes | dubEcho, droneMetal, slowedGothPop | Unblockiert, aber ZWEI NEUE REGALE („Dub & Drone“, „Dark Synth Scenes“) — also je eine eigene Scheibe nach der G10a-Form, Rubrik/Regal zusammen mit ihrem ersten Genre. AnchorFloor +droneMetal; `dubEcho`-Delay zuerst rechnen, und gegen die `(.quarter, .triplet)`, die G15a jetzt belegt |
