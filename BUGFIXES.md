...
<string>Eoel needs microphone access to transform your voice and breath into immersive audio-visual experiences.</string>

<!-- ✅ Health data permission (future HRV integration) -->
<key>NSHealthShareUsageDescription</key>
<string>Eoel may use heart rate data to create adaptive audio-visual experiences.</string>
...
.alert("Microphone Access Required", isPresented: $showPermissionAlert) {
    ...
    Text("Eoel needs microphone access to create music from your voice. Please enable it in Settings.")
}
...
**Repository:** https://github.com/vibrationalforce/eoel-ios-app
