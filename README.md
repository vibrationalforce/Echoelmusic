...
**GitHub:** `vibrationalforce/echoel-ios-app`
...
ECHOEL is an **embodied multimodal music system** that transforms biometric signals (HRV, heart rate, breathing), voice, gestures, and facial expressions into:
...
- **[ECHOEL_IMPLEMENTATION_ROADMAP.md](ECHOEL_IMPLEMENTATION_ROADMAP.md)** - Full roadmap
- **[ECHOEL_90_DAY_ROADMAP.md](ECHOEL_90_DAY_ROADMAP.md)** - 90-day plan
...
<string>ECHOEL needs microphone access to process your voice</string>

<!-- Health Data -->
<key>NSHealthShareUsageDescription</key>
<string>ECHOEL needs access to heart rate data for bio-reactive music</string>

<!-- Camera (for face tracking) -->
<key>NSCameraUsageDescription</key>
<string>ECHOEL uses face tracking for expressive control</string>
```
...
See `ECHOEL_IMPLEMENTATION_ROADMAP.md` for details.

---

## 📜 License

Copyright © 2025 ECHOEL Studio. All rights reserved.
...
> "ECHOEL is not just a music app - it's an interface to embodied consciousness.
