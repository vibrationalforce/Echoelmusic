...
- [DeviceCapabilities.swift](Sources/Eoel/Utils/DeviceCapabilities.swift) - `canUseSpatialAudioEngine` Check hinzugefügt
- [AudioEngine.swift](Sources/Eoel/Audio/AudioEngine.swift) - Runtime iOS Version Check

**Ergebnis:**
- ✅ Eoel läuft jetzt auf **iPhone 6s und neuer** (iOS 15+)
...
3. Build Status auf https://github.com/vibrationalforce/eoel-ios-app/actions ansehen
...
# → Sieh Status auf: https://github.com/vibrationalforce/eoel-ios-app/actions
```
...
### Projekt
- **GitHub Repo:** https://github.com/vibrationalforce/eoel-ios-app
- **GitHub Actions:** https://github.com/vibrationalforce/eoel-ios-app/actions
