    ...
    private var warningContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Use of visual effects is at your own risk. By acknowledging this warning, you accept full responsibility and agree to hold EOEL harmless from any adverse effects.")
                    .font(.system(size: 11))
                    .foregroundColor(.white.opacity(0.7))
                    .fixedSize(horizontal: false, vertical: true)
            }
