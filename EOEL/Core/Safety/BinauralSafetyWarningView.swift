    ...
    private var warningContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Use of binaural beats is AT YOUR OWN RISK. By acknowledging this warning, you accept FULL RESPONSIBILITY for any effects or consequences and agree to HOLD EOEL HARMLESS from any adverse effects, injuries, or damages arising from use.")
                    .font(.system(size: 11))
                    .foregroundColor(.white.opacity(0.7))
                    .fixedSize(horizontal: false, vertical: true)
            }
