...
struct StartRecordingIntent: AppIntent {
    ...
    static var description = IntentDescription("Start recording audio in EOEL")
...
struct CreateProjectIntent: AppIntent {
    ...
    static var description = IntentDescription("Create a new music project in EOEL")
...
struct EOELShortcutsProvider: AppShortcutsProvider {
...
/*
 ...
 func updateCurrentProject(_ project: Project) {
     ...
     // Reload widget
     WidgetCenter.shared.reloadTimelines(ofKind: "EOELWidget")
 }
 */
