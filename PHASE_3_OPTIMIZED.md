...
**File:** `Sources/Echoel/LED/MIDIToLightMapper.swift`
```swift
...
**File:** `Sources/Echoel/Spatial/SpatialAudioEngine.swift` (482 lines)
...
**File:** `Sources/Echoel/Visual/MIDIToVisualMapper.swift` (396 lines)
...
**File:** `Sources/Echoel/LED/Push3LEDController.swift` (458 lines)
...
**File:** `Sources/Echoel/LED/MIDIToLightMapper.swift` (463 lines)
...
FILES CHANGED:
M  Sources/Echoel/LED/MIDIToLightMapper.swift (+58 lines)
M  Sources/Echoel/Unified/UnifiedControlHub.swift (+87 lines)
M  Sources/Echoel/Views/Components/SpatialAudioControlsView.swift
D  Sources/Echoel/Audio/SpatialAudioEngine.swift
R  Sources/Echoel/Visuals/MIDIToVisualMapper.swift → Visual/
