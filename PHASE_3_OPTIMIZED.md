...
**File:** `Sources/Eoel/LED/MIDIToLightMapper.swift`
```swift
...
**File:** `Sources/Eoel/Spatial/SpatialAudioEngine.swift` (482 lines)
...
**File:** `Sources/Eoel/Visual/MIDIToVisualMapper.swift` (396 lines)
...
**File:** `Sources/Eoel/LED/Push3LEDController.swift` (458 lines)
...
**File:** `Sources/Eoel/LED/MIDIToLightMapper.swift` (463 lines)
...
FILES CHANGED:
M  Sources/Eoel/LED/MIDIToLightMapper.swift (+58 lines)
M  Sources/Eoel/Unified/UnifiedControlHub.swift (+87 lines)
M  Sources/Eoel/Views/Components/SpatialAudioControlsView.swift
D  Sources/Eoel/Audio/SpatialAudioEngine.swift
R  Sources/Eoel/Visuals/MIDIToVisualMapper.swift → Visual/
