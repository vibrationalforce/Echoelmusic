# Eoel - iOS Kompatibilität & Features

## 📱 Unterstützte iOS Versionen

### Minimum: iOS 15.0+ ✅
Eoel läuft auf **iOS 15.0 und höher**.

Das bedeutet Eoel funktioniert auf:
...
Eoel erkennt automatisch, welche Features verfügbar sind:
...
Wenn Features nicht verfügbar sind, nutzt Eoel automatisch Fallback-Modi:
...
**Workaround:** In iOS Settings → Eoel → Microphone → "Always Allow"
...
**Bottom Line:** Jeder mit iOS 15+ kann Eoel nutzen, aber neuere Versionen bekommen mehr Features! 🚀
