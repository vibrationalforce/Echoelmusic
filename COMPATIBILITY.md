# ECHOEL - iOS Kompatibilität & Features

## 📱 Unterstützte iOS Versionen

### Minimum: iOS 15.0+ ✅
ECHOEL läuft auf **iOS 15.0 und höher**.

Das bedeutet ECHOEL funktioniert auf:
...
ECHOEL erkennt automatisch, welche Features verfügbar sind:
...
Wenn Features nicht verfügbar sind, nutzt ECHOEL automatisch Fallback-Modi:
...
**Workaround:** In iOS Settings → ECHOEL → Microphone → "Always Allow"
...
**Bottom Line:** Jeder mit iOS 15+ kann ECHOEL nutzen, aber neuere Versionen bekommen mehr Features! 🚀
