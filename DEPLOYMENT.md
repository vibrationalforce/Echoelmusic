# 📱 ECHOEL - Deployment Guide

**VS Code First Development Workflow**

This guide explains how to develop ECHOEL in VS Code and deploy to your iPhone.
...
**1. Clone Repository**
```bash
git clone https://github.com/vibrationalforce/echoel-ios-app.git
cd echoel-ios-app
```
...
- Edit Swift files in `Sources/Echoel/`
...
This will:
1. ✅ Build the project
2. ✅ Generate Xcode project (`Echoel.xcodeproj`)
3. ✅ Open Xcode automatically
4. ✅ Show deployment instructions

**Step 2: In Xcode (5 minutes)**

1. **Select Target:** Click "Echoel" in project navigator
...
**In VS Code:**
1. Create new file in `Sources/Echoel/`
2. Write code
