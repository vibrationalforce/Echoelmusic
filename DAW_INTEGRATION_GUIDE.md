# 🎹 DAW Integration Guide - Eoel iOS App
...
**Mapping:**
- Eoel Fist → Seaboard Note On
- Eoel Pinch → Seaboard Glide (pitch bend)
- Eoel Spread → Seaboard Press (brightness)
...
2. ✅ Eoel MIDI 2.0 Output selected
...
- **Control:** Eoel gestures → Live looping
