# 🎹 DAW Integration Guide - ECHOEL iOS App

Complete guide for integrating ECHOEL's MIDI 2.0 + MPE output with professional DAWs and MPE synths.

---

## 🎯 Quick Start

### **ECHOEL is now broadcasting:**
- **MIDI 2.0 Virtual Source:** "ECHOEL MIDI 2.0 Output"
...
After launching ECHOEL, you should see in console:
```
...
- ECHOEL should appear as "ECHOEL MIDI 2.0 Output"
- Protocol: MIDI 2.0
- Status: Active
...
1. **Preferences → Link, Tempo & MIDI**
   - **Track:** Enable "ECHOEL MIDI 2.0 Output"
   - **Remote:** Enable "ECHOEL MIDI 2.0 Output"
   - **MPE:** Enable MPE mode
...
3. **Create MIDI Track**
   - **MIDI From:** ECHOEL MIDI 2.0 Output
   - **Monitor:** In
...
| ECHOEL Gesture | MPE Control | Ableton Parameter |
|--------------|-------------|-------------------|
...
Map ECHOEL gestures to Logic Smart Controls:
...
1. **Settings → Controllers**
   ...
   - **MIDI Input:** ECHOEL MIDI 2.0 Output
   - **MPE:** Enabled
...
Bitwig's modulation system works perfectly with ECHOEL:
...
### **Roli Seaboard (Receiving ECHOEL MIDI)**

**ECHOEL can control Seaboard synth module:**
...
**Mapping:**
- ECHOEL Fist → Seaboard Note On
- ECHOEL Pinch → Seaboard Glide (pitch bend)
- ECHOEL Spread → Seaboard Press (brightness)
...
1. **LinnStrument Control Panel:**
   - **MIDI Mode:** MPE
   - **Receiving:** ECHOEL MIDI 2.0 Output
   - **Channels:** 1-15

**Use Case:** ECHOEL triggers notes, LinnStrument lights follow
...
ECHOEL generates spatial positions based on MIDI notes:
...
2. **ECHOEL will automatically use:**
...
ECHOEL sends SysEx to Push 3 for LED feedback:
...
2. **ECHOEL sends SysEx:** `F0 00 21 1D 01 01 0A ...`
...
2. ✅ ECHOEL MIDI 2.0 Output selected
...
- **Control:** ECHOEL gestures → Live looping
- **Visual:** Projected visuals from ECHOEL
