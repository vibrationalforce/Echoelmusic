# 🎯 ECHOEL DEVELOPMENT TODO — Claude Code Edition
...
- [x] Node-basierte Architektur (EchoelNode)
...
- [ ] `Sources/Echoel/Biofeedback/BioMappingPresets.swift` erstellen
...
- [ ] `Sources/Echoel/Biofeedback/BioParameterMapping.swift` implementieren
  - [ ] Struct für Mapping-Konfiguration
  - [ ] `.apply(to bioData: BioData)` Methode
  - [ ] Kalman Filter für Signal-Smoothing

- [ ] `Sources/Echoel/UI/PresetSelectionView.swift` UI
