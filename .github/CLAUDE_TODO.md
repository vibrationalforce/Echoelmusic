# 🎯 Eoel DEVELOPMENT TODO — Claude Code Edition
...
- [x] Node-basierte Architektur (EoelNode)
...
- [ ] `Sources/Eoel/Biofeedback/BioMappingPresets.swift` erstellen
...
- [ ] `Sources/Eoel/Biofeedback/BioParameterMapping.swift` implementieren
  - [ ] Struct für Mapping-Konfiguration
  - [ ] `.apply(to bioData: BioData)` Methode
  - [ ] Kalman Filter für Signal-Smoothing

- [ ] `Sources/Eoel/UI/PresetSelectionView.swift` UI
