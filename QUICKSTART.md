# ECHOEL - Quick Start Guide

This guide will help you build and install the Echoel app on your iPhone **without needing the full Xcode application**.
...
1. **App Icon** - "Echoel" on your home screen
...
Edit [ContentView.swift](Sources/Echoel/ContentView.swift):
...
Edit [ParticleView.swift](Sources/Echoel/ParticleView.swift):
...
Edit [MicrophoneManager.swift](Sources/Echoel/MicrophoneManager.swift):
