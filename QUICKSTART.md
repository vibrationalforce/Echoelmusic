# Eoel - Quick Start Guide

This guide will help you build and install the Eoel app on your iPhone **without needing the full Xcode application**.
...
1. **App Icon** - "Eoel" on your home screen
...
Edit [ContentView.swift](Sources/Eoel/ContentView.swift):
...
Edit [ParticleView.swift](Sources/Eoel/ParticleView.swift):
...
Edit [MicrophoneManager.swift](Sources/Eoel/MicrophoneManager.swift):
