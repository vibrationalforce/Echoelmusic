...
### 3. GitHub Repository
- Du hast bereits: https://github.com/vibrationalforce/echoelmusic-app
...
```
→ Gehe zu: https://github.com/vibrationalforce/echoelmusic-app/settings/secrets/actions
...
```markdown
# In README.md:
![iOS Build](https://github.com/vibrationalforce/echoelmusic-app/workflows/iOS%20Build%20%26%20Test/badge.svg)
```
