...
Dieses Dokument erklärt, wie du Eoel automatisch via GitHub Actions bauen und auf dein iPhone über TestFlight installieren kannst - **OHNE lokales Xcode**!
...
### 3. GitHub Repository
- Du hast bereits: https://github.com/vibrationalforce/eoel-ios-app
...
→ Klicke auf "+" (neue ID)
→ Wähle "App IDs" → "App"
→ Description: "Eoel Biofeedback Music"
...
```
→ Gehe zu: https://github.com/vibrationalforce/eoel-ios-app/settings/secrets/actions
...
→ Drag & Drop alle .swift files aus Sources/Eoel/
...
# Auf GitHub prüfen
→ https://github.com/vibrationalforce/eoel-ios-app/actions
→ Du solltest einen laufenden Workflow sehen
```

**5.3. Ersten Build triggern**
```
→ Gehe zu: https://github.com/vibrationalforce/eoel-ios-app/actions
...
**6.3. Eoel auf iPhone installieren**
```
...
2. Eoel App → "Update" (wenn neue Version)
...
```markdown
# In README.md:
![iOS Build](https://github.com/vibrationalforce/eoel-ios-app/workflows/iOS%20Build%20%26%20Test/badge.svg)
```
