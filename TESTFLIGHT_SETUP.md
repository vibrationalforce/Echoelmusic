...
Dieses Dokument erklärt, wie du ECHOEL automatisch via GitHub Actions bauen und auf dein iPhone über TestFlight installieren kannst - **OHNE lokales Xcode**!
...
### 3. GitHub Repository
- Du hast bereits: https://github.com/vibrationalforce/echoel-ios-app
...
→ Klicke auf "+" (neue ID)
→ Wähle "App IDs" → "App"
→ Description: "ECHOEL Biofeedback Music"
...
```
→ Gehe zu: https://github.com/vibrationalforce/echoel-ios-app/settings/secrets/actions
...
→ Drag & Drop alle .swift files aus Sources/Echoel/
...
# Auf GitHub prüfen
→ https://github.com/vibrationalforce/echoel-ios-app/actions
→ Du solltest einen laufenden Workflow sehen
```

**5.3. Ersten Build triggern**
```
→ Gehe zu: https://github.com/vibrationalforce/echoel-ios-app/actions
...
**6.3. ECHOEL auf iPhone installieren**
```
...
2. ECHOEL App → "Update" (wenn neue Version)
...
```markdown
# In README.md:
![iOS Build](https://github.com/vibrationalforce/echoel-ios-app/workflows/iOS%20Build%20%26%20Test/badge.svg)
```
