...
### Ziel
Sicherstellen, dass ECHOEL auf iOS 15.0+ ohne Crashes oder Feature-Failures läuft.
...
| `.preferredColorScheme()` | iOS 13.0 | EchoelApp | ✅ OK |
...
ECHOEL verwendet Runtime Feature Detection für iOS version-spezifische Features:
