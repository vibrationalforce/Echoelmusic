...
### Ziel
Sicherstellen, dass Eoel auf iOS 15.0+ ohne Crashes oder Feature-Failures läuft.
...
| `.preferredColorScheme()` | iOS 13.0 | EoelApp | ✅ OK |
...
Eoel verwendet Runtime Feature Detection für iOS version-spezifische Features:
