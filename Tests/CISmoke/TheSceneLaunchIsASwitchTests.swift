...
final class TheSceneLaunchIsASwitchTests: XCTestCase {
    ...
    func testThePlayerSwitchesThroughTheOneLaunchRule() throws {
        ...
        XCTAssertTrue(scene.contains("launchableLaneID(ofRegion: regionID)"))
        XCTAssertTrue(scene.contains("launch.requestScene("))
    ...
    func testTheSceneButtonMakesOnePlayerCall() throws {
        ...
        XCTAssertTrue(scene.contains("player.launchScene(Array(scene.cells.values), quantize: SessionGrid.quantize)"))
