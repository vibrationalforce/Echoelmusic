...
// longest release. Every other NaN boundary in this repo lands on the FLOOR through
// `Core/FloatingPointClamp` — two spellings of one decision, with opposite answers (#416).
