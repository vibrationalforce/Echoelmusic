...
// `EchoelGranular.swift` made it 40 (#1305 then deleted it and `EchoelHarmonizer.swift`;
// MEASURE, do not quote — `ls Sources/Echoelmusic/DSP/*.swift | wc -l`). So this is a
// correction plus an increment, not an
...
//
// WHAT THIS GUARDS. `DSP/` is a pure processing layer: every file's entire import set is
...
//
// ⚠️ AND IT IS NOT "LINUX-TESTABLE", deliberately not written anywhere: a handful import
