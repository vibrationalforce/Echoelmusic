#!/bin/bash
#
# deploy.sh - Deploy EOEL to iPhone (via Xcode)
...
# Banner
echo -e "${MAGENTA}╔═══════════════════════════════════════╗${NC}"
echo -e "${MAGENTA}║  📱 EOEL - Deploy to iPhone         ║${NC}"
echo -e "${MAGENTA}╚═══════════════════════════════════════╝${NC}"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    if command -v xcodebuild &> /dev/null; then
        ...
        echo ""
        echo -e "   ${GREEN}a)${NC} Select the 'Eoel' target in the project navigator"
        echo -e "   ${GREEN}b)${NC} Go to 'Signing & Capabilities' tab"
        echo -e "   ${GREEN}c)${NC} Select your Team (Apple ID)"
        echo -e "   ${GREEN}d)${NC} Bundle ID: ${CYAN}com.vibrationalforce.eoel${NC}"
        echo ""
